...
public class ViewGraphique extends View{
    ...
    public ViewGraphique() {
        ...
        fenetre.setTitle("Plateau de Jeu");       
    ...
    public void nettoie(){
    //remet tous les texte de l'ihm graphique à zéro(a la situation de départ)
    ...
    //réactive la case dont le numéro et celui du parametre et change le texte a rien 
        i--; 
